...
class Promise[T] protected () extends js.Object {
  def this(executor: js.Function2[js.Function1[T | js.Thenable[T], Unit], js.Function1[js.Any, Unit], Unit]) = this()
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[T, TResult1 | js.Thenable[TResult1]] | Null = ???, onrejected: js.Function1[js.Any, TResult2 | js.Thenable[TResult2]] | Null = ???): Promise[TResult1 | TResult2] = js.native
}
...
object Promise extends js.Object {
  ...
  def as[T, SomePromise <: js.Thenable[T]](value: SomePromise): SomePromise = js.native
  def as[T](value: T): Promise[T] = js.native
  def join[T1, T2](promises: js.Tuple2[T1 | js.Thenable[T1], T2 | js.Thenable[T2]]): Promise[js.Tuple2[T1, T2]] = js.native
  def join[T](promises: js.Array[T | js.Thenable[T]]): Promise[js.Array[T]] = js.native
  def wrap[T](value: T | js.Thenable[T]): Promise[T] = js.native
...
trait ICursorStateComputer extends js.Object {
  def apply(inverseEditOperations: js.Array[IIdentifiedSingleEditOperation]): js.Array[Selection] | Null = js.native
}
...
trait ITextModel extends js.Object {
  ...
  def findMatches(searchString: String, searchOnlyEditableRange: Boolean, isRegex: Boolean, matchCase: Boolean, wordSeparators: String | Null, captureMatches: Boolean, limitResultCount: Double): js.Array[FindMatch] = js.native
  def findMatches(searchString: String, searchScope: IRange, isRegex: Boolean, matchCase: Boolean, wordSeparators: String | Null, captureMatches: Boolean, limitResultCount: Double): js.Array[FindMatch] = js.native
  def findNextMatch(searchString: String, searchStart: IPosition, isRegex: Boolean, matchCase: Boolean, wordSeparators: String | Null, captureMatches: Boolean): FindMatch | Null = js.native
  def findPreviousMatch(searchString: String, searchStart: IPosition, isRegex: Boolean, matchCase: Boolean, wordSeparators: String | Null, captureMatches: Boolean): FindMatch | Null = js.native
  ...
  def pushEditOperations(beforeCursorState: js.Array[Selection], editOperations: js.Array[IIdentifiedSingleEditOperation], cursorStateComputer: ICursorStateComputer): js.Array[Selection] | Null = js.native
  ...
  def onDidChangeLanguageConfiguration(listener: js.Function1[IModelLanguageConfigurationChangedEvent, Unit]): IDisposable = js.native
...
trait IEditOperationBuilder extends js.Object {
  def addEditOperation(range: Range, text: String | Null): Unit = js.native
  def addTrackedEditOperation(range: Range, text: String | Null): Unit = js.native
...
trait IEditorOptions extends js.Object {
  ...
  var tabCompletion: Boolean | String = js.native
...
trait InternalSuggestOptions extends js.Object {
  ...
  def localityBonus: Boolean = js.native
}

@js.native
trait InternalParameterHintOptions extends js.Object {
  def enabled: Boolean = js.native
  def cycle: Boolean = js.native
}
...
trait InternalEditorViewOptions extends js.Object {
  ...
  def renderCustomLineNumbers: js.Function1[Double, String] | Null = js.native
...
trait EditorContribOptions extends js.Object {
  ...
  def parameterHints: InternalParameterHintOptions = js.native
  ...
  def tabCompletion: String = js.native
...
class InternalEditorOptions extends js.Object {
  ...
  def autoClosingBrackets: EditorAutoClosingStrategy = js.native
  def autoClosingQuotes: EditorAutoClosingStrategy = js.native
  def autoSurround: EditorAutoSurroundStrategy = js.native
  ...
  def copyWithSyntaxHighlighting: Boolean = js.native
...
trait IConfigurationChangedEvent extends js.Object {
  ...
  def autoClosingQuotes: Boolean = js.native
  def autoSurround: Boolean = js.native
  def autoIndent: Boolean = js.native
  def useTabStops: Boolean = js.native
  def tabFocusMode: Boolean = js.native
  def dragAndDrop: Boolean = js.native
...
trait ICodeEditor extends IEditor {
  ...
  def onDidChangeModelLanguageConfiguration(listener: js.Function1[IModelLanguageConfigurationChangedEvent, Unit]): IDisposable = js.native
  ...
  override def setModel(model: IEditorModel | Null): Unit = js.native
  ...
  def executeEdits(source: String, edits: js.Array[IIdentifiedSingleEditOperation], endCursorState: js.Array[Selection] = ???): Boolean = js.native
...
object Editor extends js.Object {
  ...
  def createDiffEditor(domElement: HTMLElement, options: IDiffEditorConstructionOptions = ???, `override`: IEditorOverrideServices = ???): IStandaloneDiffEditor = js.native
...
trait CodeActionProvider extends js.Object {
  def provideCodeActions(model: editor.ITextModel, range: Range, context: CodeActionContext, token: CancellationToken): js.Array[Command | CodeAction] | Thenable[js.Array[Command | CodeAction]] = js.native
}
...
trait HoverProvider extends js.Object {
  def provideHover(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[Hover] = js.native
}
...
trait CompletionItemProvider extends js.Object {
  ...
  def provideCompletionItems(model: editor.ITextModel, position: Position, context: CompletionContext, token: CancellationToken): ProviderResult[CompletionList] = js.native
  def resolveCompletionItem(model: editor.ITextModel, position: Position, item: CompletionItem, token: CancellationToken): ProviderResult[CompletionItem] = js.native
}
...
@js.native
@JSGlobal("monaco.languages.SignatureHelpTriggerReason")
object SignatureHelpTriggerReason extends js.Object {
  var Invoke: SignatureHelpTriggerReason = js.native
  var TriggerCharacter: SignatureHelpTriggerReason = js.native
  var ContentChange: SignatureHelpTriggerReason = js.native
  @JSBracketAccess
  def apply(value: SignatureHelpTriggerReason): String = js.native
}

@js.native
trait SignatureHelpContext extends js.Object {
  def triggerReason: SignatureHelpTriggerReason = js.native
...
trait SignatureHelpProvider extends js.Object {
  ...
  def provideSignatureHelp(model: editor.ITextModel, position: Position, token: CancellationToken, context: SignatureHelpContext): ProviderResult[SignatureHelp] = js.native
}
...
trait DocumentHighlightProvider extends js.Object {
  def provideDocumentHighlights(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[js.Array[DocumentHighlight]] = js.native
}
...
trait ReferenceProvider extends js.Object {
  def provideReferences(model: editor.ITextModel, position: Position, context: ReferenceContext, token: CancellationToken): ProviderResult[js.Array[Location]] = js.native
}
...
trait DefinitionProvider extends js.Object {
  def provideDefinition(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[Definition | js.Array[DefinitionLink]] = js.native
}

@js.native
trait ImplementationProvider extends js.Object {
  def provideImplementation(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[Definition | js.Array[DefinitionLink]] = js.native
}

@js.native
trait TypeDefinitionProvider extends js.Object {
  def provideTypeDefinition(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[Definition | js.Array[DefinitionLink]] = js.native
}
...
trait DocumentSymbolProvider extends js.Object {
  ...
  def provideDocumentSymbols(model: editor.ITextModel, token: CancellationToken): ProviderResult[js.Array[DocumentSymbol]] = js.native
}
...
trait DocumentFormattingEditProvider extends js.Object {
  def provideDocumentFormattingEdits(model: editor.ITextModel, options: FormattingOptions, token: CancellationToken): ProviderResult[js.Array[TextEdit]] = js.native
}

@js.native
trait DocumentRangeFormattingEditProvider extends js.Object {
  def provideDocumentRangeFormattingEdits(model: editor.ITextModel, range: Range, options: FormattingOptions, token: CancellationToken): ProviderResult[js.Array[TextEdit]] = js.native
}

@js.native
trait OnTypeFormattingEditProvider extends js.Object {
  var autoFormatTriggerCharacters: js.Array[String] = js.native
  def provideOnTypeFormattingEdits(model: editor.ITextModel, position: Position, ch: String, options: FormattingOptions, token: CancellationToken): ProviderResult[js.Array[TextEdit]] = js.native
}
...
trait LinkProvider extends js.Object {
  def provideLinks(model: editor.ITextModel, token: CancellationToken): ProviderResult[js.Array[ILink]] = js.native
...
trait DocumentColorProvider extends js.Object {
  def provideDocumentColors(model: editor.ITextModel, token: CancellationToken): ProviderResult[js.Array[IColorInformation]] = js.native
  def provideColorPresentations(model: editor.ITextModel, colorInfo: IColorInformation, token: CancellationToken): ProviderResult[js.Array[IColorPresentation]] = js.native
}
...
trait FoldingRangeProvider extends js.Object {
  def provideFoldingRanges(model: editor.ITextModel, context: FoldingContext, token: CancellationToken): ProviderResult[js.Array[FoldingRange]] = js.native
}
...
trait RenameProvider extends js.Object {
  def provideRenameEdits(model: editor.ITextModel, position: Position, newName: String, token: CancellationToken): ProviderResult[WorkspaceEdit with Rejection] = js.native
  def resolveRenameLocation(model: editor.ITextModel, position: Position, token: CancellationToken): ProviderResult[RenameLocation with Rejection] = js.native
}
...
trait CodeLensProvider extends js.Object {
  ...
  def provideCodeLenses(model: editor.ITextModel, token: CancellationToken): ProviderResult[js.Array[ICodeLensSymbol]] = js.native
  def resolveCodeLens(model: editor.ITextModel, codeLens: ICodeLensSymbol, token: CancellationToken): ProviderResult[ICodeLensSymbol] = js.native
}
...
object Typescript extends js.Object {
  type CompilerOptionsValue = String | Double | Boolean | js.Array[String | Double] | js.Array[String] | MapLike[js.Array[String]] | Null | Unit
  var typescriptDefaults: LanguageServiceDefaults = js.native
  var javascriptDefaults: LanguageServiceDefaults = js.native
  var getTypeScriptWorker: js.Function0[Promise[js.Any]] = js.native
  var getJavaScriptWorker: js.Function0[Promise[js.Any]] = js.native
}
...
object Languages extends js.Object {
  ...
  def setTokensProvider(languageId: String, provider: TokensProvider | EncodedTokensProvider): IDisposable = js.native
...
object MonacoEditorVersion {def apply: String = "0.15.6"}
